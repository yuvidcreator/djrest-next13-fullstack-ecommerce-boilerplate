...
import useOnClickOutside from "@/components/utils/use-click-outside";
						...
						>
							...
							>
								<button
									...
									className={cn(
										"fixed z-10 inline-flex items-center justify-center w-7 h-7 md:w-8 md:h-8 rounded-full bg-white shadow text-black transition duration-200 focus:outline-none focus:text-gray-800 focus:shadow-md hover:text-white hover:shadow-md",
