...
const HeaderTwo: React.FC = () => {
  ...
  // console.log(isAuthorized);
    ...
    return (
        ...
        >
            <div className='fixed z-20 w-full h-16 text-gray-100 transition duration-200 ease-in-out bg-black innerSticky body-font sm:h-20 lg:h-36 xl:h-40 px-4 2xl:px-16'>
                <div className='flex items-center justify-center md:justify-around mx-auto max-w-[1920px] h-full lg:h-20 xl:h-24 w-full relative before:absolute before:w-screen before:h-px before:bg-gray-100 before:bottom-0'>
                    <button
                        aria-label='Menu'
                    ...
                    <div className='flex items-center justify-end flex-shrink-0'>
                        ...
                        {/* for Tab View */}
                            ...
                            {/* <div className='text-sm font-semibold xl:text-base text-gray-100' onClick={handleLogout}>
                                {t('text-logout')}
                            </div> */}
                        </div>
                ...
                <div className='items-center hidden lg:flex lg:h-16 headerBottom mx-auto max-w-[1920px]'>
                    ...
                    <div className='flex items-center flex-shrink-0 ms-auto gap-x-7 text-gray-100'>   
                        {/* @ts-ignore */}
                        <AuthMenu
