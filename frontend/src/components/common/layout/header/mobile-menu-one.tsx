...
const social = [
	{
		id: 0,
		link: "https://www.facebook.com/osty/",
		icon: <IoLogoFacebook />,
		className: "facebook",
		title: "text-facebook",
	},
	...
	{
		id: 3,
		link: "https://www.instagram.com/osty/",
...
export default function MobileMenuOne() {
	...
	return (
		<>
			<div className="flex flex-col justify-self-start w-full h-full bg-black">
				...
				<Scrollbar className="menu-scrollbar flex-grow mb-auto">
					<div className="flex flex-col pt-0 pb-8 px-0 lg:px-2 text-gray-100">
				...
				<div className="flex items-center justify-center bg-black border-t border-gray-100 px-7 flex-shrink-0 space-s-1 mt-96">
