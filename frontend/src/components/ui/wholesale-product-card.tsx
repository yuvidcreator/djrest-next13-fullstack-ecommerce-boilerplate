...
import ProductCardSwiper from '../client/Products/MyProductCard/ProductCardSwiper'
...
const MyWholeSaleProductCard: FC<ProductProps> = ({
    product,
    className = '',
    contactClassName = '',
        ...
        >
                ...
                {product.sub_products[active].discount &&
                    ...
                    <span className='bg-heading text-white text-10px md:text-xs leading-5 rounded-md inline-block px-1 sm:px-1.5 xl:px-2 py-0.5 sm:py-1'>
                        <p>
                            ...
                            {product.sub_products[active].discount} <span className='hidden sm:inline'>%</span>
                        </p>
                    </span>
                )}
            ...
            {(variant === 'gridModern' ||
                ...
                <div className='py-2 flex items-center gap-x-2'>
                    ...
                    {product.sub_products.map((pos) => {return pos.is_out_of_stock}) && (
...
export default MyWholeSaleProductCard
